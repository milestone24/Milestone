...
import { securityDailyHistory } from "@server/db/schema"
...
export const getSecurityHistoryForDateRange = async (securityId: string, startDate: Date, endDate: Date): Promise<SecurityDailyHistorySelect[]> => {

  console.log("GETTING SECURITY HISTORY FOR DATE RANGE", securityId, startDate, endDate)
