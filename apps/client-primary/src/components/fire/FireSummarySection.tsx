...
import { DecimalValueString } from "@milestone/js-common/schema";
import {
  formatYears,
  retirementBadgeVariant,
...
export function FireSummarySection({
  ...
  const statusBadge = retirementStatusBadge(ahead, behind);
  const badgeVariant = retirementBadgeVariant(ahead, behind);
