...
import { webPlatformServices } from "@/lib/platform-services";
...
} from "./hooks/use-broker-platforms";
...
const AccountCreateOne = lazy(
  () => import("@/pages/scratches/account-create-one"),
);
...
function App() {
  return (
    <PlatformServicesProvider services={webPlatformServices}>
      <AppContent />
