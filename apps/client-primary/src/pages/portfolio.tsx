...
import { AssetValueTimePoint, assetValueTimePointSchema, UserAssetOrphanInsert } from "@milestone/js-common/schema";
...
import { CombinedDayTimePointBase } from "@milestone/js-common/schema";
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      <BrokerLogoBoxed
                        broker={
                          platformName
                            ? getPlatformSlugFromName(platformName)
                            : undefined
                        }
                        size="md"
                      />
