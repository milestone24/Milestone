...
export const getSecurityHistoryForDateRange = async (identifier: SecurityIdentifier, startDate: Date, endDate: Date): Promise<SecurityHistory[]> => {
...
export const getSecurityHistoryLiveForDateRange = async (identifier: SecurityIdentifier, startDate: Date, endDate: Date): Promise<SecurityHistory[]> => {
...
export const getSecurityHistoryForDate = async (identifier: SecurityIdentifier, date: Date): Promise<SecurityHistory | null> => {
...
export const getCalculatedSecurityHistoryForDateRange = async (identifier: SecurityIdentifier, holdings: number, startDate: Date, endDate: Date): Promise<SecurityHistory[]> => {
